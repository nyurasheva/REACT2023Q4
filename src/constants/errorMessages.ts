...
const NOT_LEADING =
  'Это поле не должно содержать ведущих или завершающих пробелов';
...
const SUCCESS_REGISTRATION_MEGGAGE =
  'Поздравляем! Вы успешно зарегистрировались!';
const NO_CORRECT_POST_CODE =
  'Некорректный почтовый индекс для выбранной страны: ';
